...
- More in depth README files for the Dashboard Web App can be found in the Dashboard folder and for the [iOS App](https://github.com/AstraAppivate/hackathon-2025-team-3/blob/main/SafePassage/README.md) in the iOS folder.
